...
# limitations under the License.import multiprocessing
...
class PythonFuzzerEngine(multiprocessing.Process):
    '''
    ...
    def __init__(self):
        super(PythonFuzzerEngine, self).__init__()
    ...
    def fuzz(self, target_path, options, reproducers_dir, max_time):
        ...
        For a demonstartion see src/fuzzers/dummy_fuzzer.py.
    ...
    def minimize_testcase(self, target_path, arguments, input_path, output_path, max_time):
