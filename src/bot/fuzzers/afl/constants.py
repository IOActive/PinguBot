...
MUTATION_STATE_FLAG = '-P'

INPUT_TYPE_FLAG = '-a'

# AFL MUTATION suboptions.
MUTATION_EXPLORE = 'explore'

MUTATION_EXPLOIT = 'exploit'
...
IGNORE_SEED_PROBLEMS = 'AFL_IGNORE_SEED_PROBLEMS'

FAST_CAL_ENV_VAR = 'AFL_FAST_CAL'

FORKSRV_INIT_TMOUT_ENV_VAR = 'AFL_FORKSRV_INIT_TMOUT'

KEEP_TIMEOUTS_ENV_VAR = 'AFL_KEEP_TIMEOUTS'
