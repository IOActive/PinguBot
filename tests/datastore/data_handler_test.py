...
class AddBuildMetadataTest(unittest.TestCase):
  ...
  def _test(self, is_bad_build):
    ...
    self.assertEqual('bot_working_directory', builds[0].bot_name)
...
class UpdateTestcaseCommentTest(unittest.TestCase):
  ...
  def test_update_comment_empty(self):
    ...
    self.assertEqual(
        '[2019-01-01 00:00:00] bot_working_directory: Progression task started: message.\n',
        self.testcase.comments)
  ...
  def test_update_comment_clear(self):
    ...
    self.testcase.comments = (
        '[2018-01-01 00:00:00] bot_working_directory: Foo.\n'
        '[2018-01-01 00:00:00] bot_working_directory: Progression task started: message.\n'
        '[2018-01-01 00:00:00] bot_working_directory: Bar.\n'
        '[2018-01-01 00:00:00] bot_working_directory: Progression task finished.\n'
        '[2018-01-01 00:00:00] bot_working_directory: Blah.\n')
    data_handler.update_testcase_comment(
        self.testcase, data_types.TaskState.STARTED, 'message')
    self.assertEqual(
        ('[2018-01-01 00:00:00] bot_working_directory: Foo.\n'
