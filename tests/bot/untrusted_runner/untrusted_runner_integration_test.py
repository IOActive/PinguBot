...
class UntrustedRunnerIntegrationTest(
  ...
  def test_setup_regular_build(self):
    ...
    expected_build_dir = os.path.join(
        worker_root_dir, 'bot_working_directory', 'builds', 'clusterfuzz-test-data_test_builds_'
  ...
  def test_setup_regular_build_fuzz_target(self):
    ...
    launcher_dir = os.path.join('src', 'clusterfuzz', '_internal', 'bot_working_directory',
                                'fuzzers', 'libFuzzer')
    ...
    worker_root_dir = os.environ['WORKER_ROOT_DIR']
    expected_build_dir = os.path.join(
        worker_root_dir, 'bot_working_directory', 'builds',
  ...
  def test_get_fuzz_targets(self):
    ...
    worker_test_build_dir = os.path.join(
        worker_root, 'src', 'clusterfuzz', '_internal', 'tests', 'core', 'bot_working_directory',
