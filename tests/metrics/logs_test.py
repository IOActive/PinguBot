...
class FormatRecordTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(self,
                  ['bot.metrics.logs.update_entry_with_exc'])
  ...
  def get_record(self):
    """Make a fake record."""
    os.environ['BOT_NAME'] = 'linux-bot_working_directory'
  ...
  def test_format_record(self):
    ...
    self.assertEqual({
        ...
        'severity': 'INFO',
        'bot_name': 'linux-bot_working_directory',
  ...
  def test_worker_bot_name(self):
    """Test format record with a worker bot_working_directory name."""
...
class JsonSocketHandler(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(self, ['bot.metrics.logs.format_record'])
...
class ConfigureTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch_environ(self)
    helpers.patch(self, [
        'bot.metrics.logs.get_logging_config_dict',
        'bot.metrics.logs.set_logger',
        'logging.config.dictConfig',
        'logging.getLogger',
        'bot.metrics.logs._is_running_on_app_engine',
        'bot.metrics.logs.suppress_unwanted_warnings',
...
class EmitTest(unittest.TestCase):
  ...
  def test_log_info(self):
    ...
    statement_line = inspect.currentframe().f_lineno + 1
    logs.emit(logging.INFO, 'msg', target='bot_working_directory', test='yes')
  ...
  def test_log_error(self):
    ...
    statement_line = inspect.currentframe().f_lineno + 1
    logs.emit(logging.ERROR, 'msg', exc_info='ex', target='bot_working_directory', test='yes')
...
class LogErrorTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(self,
                  ['bot.metrics.logs.emit', 'sys.exc_info'])
